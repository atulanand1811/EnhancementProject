...
public class LoanManagementController {
	...
	/**
	 * This method enable the customer to apply for loan
	 * 
	 * @param token
	...
	/*
	 * 	This method enables the customer to check loan status
	 * 	on the basis of their customer Id
	 * 
	 * 	@param custId
	 *
	 *	@return
...
//	This method just form check purpose
...
//	}
	...
	/*
	 * This method enables the authorized bank employee to approve the loan application
	 * @param applicationid
	 * 
	 * @return
	 */
	...
	/*
	 * This method enable the authorized bank employee to reject the loan application
	 */
